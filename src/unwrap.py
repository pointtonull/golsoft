...
#def unwrap_goldstein(bitflags, maxcutlen, numres, xsize, ysize,
#        branchcut_code):

#    """
#    Goldstein's phase-unwrapping algorithm. The bitflags store the masked pixels
#    (to be ignored) and the residues and accumulates other info such as the
#    branch cut pixels.
#    """
...
#        for i in xrange(xsize):
#            k = j * xsize + i
#            if (bitflags[k] & (POS_RES | NEG_RES)) and not(bitflags[k]
#                    & VISITED):
